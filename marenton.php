...
$site_id = 2; // ID de MARENTON. Changez cette valeur pour chaque page/site.
...
<?php include 'menu.php'; ?>
    ...
    <div class="container">
        ...
        foreach ($lignes as $ligne) {
            echo "<a class='button' href='dashboardlignes.php?ligne_id=" . $ligne['id'] . "'>" . htmlspecialchars($ligne['name']) . " </a>";
        }
        ?>
    </div>
</body>
